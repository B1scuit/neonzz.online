...
<head>
    ...
    <!--<link rel="stylesheet" type="text/css" href="https://www.neonzz.online/css/customalign.css" />-->
    ...
    <title>Neonzz.online :: Pong</title>
</head>
<body>
   ...
   <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
    <video class="w3-image" playsinline autoplay muted width="1500" src="/vid/Pong.mp4" type="video/mp4">
   ...
   <div class="w3-container w3-padding-32" id="downloadPong">
    <h2 class="w3-content w3-large w3-text-grey"><span class="w3-opacity-min" style="background-image: url('/img/container.png');">Pong</span></h2>
    <p class="w3-content"><span class="w3-opacity-min" style="background-image: url('/img/container.png');">Download Pong here:<br /><br /><form style="background-image: url('/img/container.png');" class="w3-content" action="https://mega.nz/file/NUkRFAwb#Km0bPLuEh1EbFzj7cO65tYxcWeUmzxenKX0ciArHY_c" method="GET" target="_blank"><button type="submit" class="btn btn-success">Pong v1.0.1</button></form></span></p>
   </div>
   <h3 class="w3-content w3-large w3-text-black"><span style="background-image: url('/img/container.png');" class="w3-opacity-min">Register to recive notifications on the latest updates if you have ideas or would like to join my development team please visit the contact us page or submit a ticket below.</span></h3><br /><br />
   <div class="w3-center verticaltext w3-content w3-padding" style="max-width: 1500px;">
    <h1 class="w3-content w3-large" ><span style="background-image: url('/img/container.png');" class="w3-opacity-min">Contact us using the form below </span></h1>
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
        ...
        <span class="w3-content form-control"><button type="submit" class="btn btn-success" id="contactbutton">Submit</button></span>
    </form>
    <br />
    <br />
   <footer>
    <div class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="Pongvideo">
        <img class="w3-image-footer" src="/img/Websitebackground.png" width="1500" height="450">
